...
#--better p-values
mod_vsq <- gam(sqrt_value ~ s(doy, by = rot_trt, bs = "cr", k = 35) + rot_trt,
             data = sw_d15y18, method = "REML")
...
#--very bad p values
mod_v2 <- gam(value_sc2 ~ s(doy, by = rot_trt, bs = "cr", k = 35) + rot_trt,
               data = sw_d15y18, method = "REML")
...
mod_v2sq <- gam(sqrt_scvalue2 ~ s(doy, by = rot_trt, bs = "cr", k = 35) + rot_trt,
              data = sw_d15y18, method = "REML")
...
mod2_v <- gam(value ~ s(doy, by = rot_trt, bs = "cr", k = 35) + rot_trt,
...
#--also very bad
mod2_vsq <- gam(sqrt_value ~ s(doy, by = rot_trt, bs = "cr", k = 35) + rot_trt,
               data = sw_d15y19, method = "REML")
...
mod2_v2 <- gam(value_sc2 ~ s(doy, by = rot_trt, bs = "cr", k = 35) + rot_trt,
              data = sw_d15y19, method = "REML")
...
#--still very bad p-values
mod2_v2sq <- gam(sqrt_scvalue2 ~ s(doy, by = rot_trt, bs = "cr", k = 35) + rot_trt,
                data = sw_d15y19, method = "REML")
...
mod3_v <- gam(value ~ s(doy, by = rot_trt, bs = "cr", k = 35) + rot_trt,
...
#--also fine
mod3_vsq <- gam(sqrt_value ~ s(doy, by = rot_trt, bs = "cr", k = 35) + rot_trt,
                data = sw_d45y18, method = "REML")
...
mod3_v2 <- gam(value_sc2 ~ s(doy, by = rot_trt, bs = "cr", k = 35) + rot_trt,
               data = sw_d45y18, method = "REML")
...
mod4_v <- gam(value ~ s(doy, by = rot_trt, bs = "cr", k = 35) + rot_trt,
...
#--also fine
mod4_vsq <- gam(sqrt_value ~ s(doy, by = rot_trt, bs = "cr", k = 35) + rot_trt,
                data = sw_d45y19, method = "REML")
...
mod4_v2 <- gam(value_sc2 ~ s(doy, by = rot_trt, bs = "cr", k = 35) + rot_trt,
               data = sw_d45y19, method = "REML")
...
res <- 
  res_d15y18 %>% 
  bind_rows(res_d15y19) %>% 
  bind_rows(res_d45y18) %>% 
  bind_rows(res_d45y19)

res %>% write_csv("01_soilsens/dat_soilsens-gam.csv")
