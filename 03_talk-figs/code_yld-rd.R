...
f_yld <- 
  ...
  scale_fill_manual(values = c("Simple" = clr_rot, 
                               "Complex" = clr_div)) + 
...
f_radd <- 
  ...
  scale_x_continuous(breaks = c(1, 2),
                     ...
                     limits = c(0.75, 2.25)) + 
  scale_color_manual(values = c("Simple" = clr_rot, 
                                "Complex" = clr_div)) + 
  labs(x = NULL,
       y = raddlab2,
       color = "Rotation") + 
...
ggsave("03_talk-figs/fig_yld-rd.png", width = 10, height = 4)
